...
from groups.models import (Fellowship, FellowshipMembership, FellowshipMeeting, CellGroup, CellGroupMembership,
                           CellGroupMeeting, ChurchGroup, ChurchGroupMembership, GroupMeeting, Ministry,
                           MinistryMembership, MinistryMeeting, )
...
class AddMemberToFellowshipSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        fellowship_membership = FellowshipMembership.objects.create(fellowship=fellowship, member=member, role=role,
                                                                    **validated_data)
...
class AddMemberToCellGroupSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        cell_group_membership = CellGroupMembership.objects.create(cell_group=cell_group, member=member, role=role,
                                                                   **validated_data)
...
class AddMemberToMinistrySerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        ministry_membership = MinistryMembership.objects.create(ministry=ministry, member=member, role=role,
                                                                **validated_data)
