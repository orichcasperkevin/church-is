...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='member.MemberRole')),
        ...
        migrations.AddField(
            ...
            name='roles',
            field=models.ManyToManyField(through='member.RoleMembership', to='member.Role'),
        ),
        migrations.CreateModel(
